...
export const socialData = [
  {
    href: 'https://www.linkedin.com/in/movara-horizon/',
    icon: 'linkedin',
    title: 'LinkedIn',
  },
  // {
...
export const testimonialsData = [
  {
    id: 1,
    quote: '...the talented team at Movara has become a go‑to partner to help develop solutions for problems that are both complex and complicated.',
    author: {
      name: 'Patrick Moore',
      position: 'CEO',
    ...
    images: {
      ...
      logo: 'https://images.unsplash.com/photo-1611162617213-7d7a39e9b1d7?w=200&h=50&fit=crop',
    },
  },
  {
    id: 2,
    quote: 'Movara\'s strategic approach transformed our business operations and delivered measurable results that exceeded our expectations.',
    author: {
      name: 'Sarah Johnson',
      position: 'CTO',
    ...
    images: {
      hero: 'https://images.unsplash.com/photo-1460925895917-afdab827c52d?w=800&h=600&fit=crop',
      logo: 'https://images.unsplash.com/photo-1611162617213-7d7a39e9b1d7?w=200&h=50&fit=crop',
    },
  },
  {
    id: 3,
    quote: 'Working with Movara was a game-changer for our organization. Their expertise in strategy execution is unmatched.',
    author: {
      name: 'Michael Chen',
      position: 'Founder',
    ...
    caseStudy: {
      title: 'Read Case Study',
      href: '/work/innovatecorp',
    },
    images: {
      hero: 'https://images.unsplash.com/photo-1552664730-d307ca884978?w=800&h=600&fit=crop',
      logo: 'https://images.unsplash.com/photo-1611162617213-7d7a39e9b1d7?w=200&h=50&fit=crop',
    },
  },
]
