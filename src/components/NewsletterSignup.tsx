    ...
    return (
      <div className={`newsletter-signup ${className}`}>
        <div className="text-center py-8">
          ...
          <p className="text-white text-lg mb-2">Thank you for subscribing!</p>
          <p className="text-gray-300 text-sm">We'll keep you updated with our latest work.</p>
        </div>
      </div>
    )
  }
        ...
        >
          ...
          <div className="icon">
            <svg width="12" height="11" viewBox="0 0 12 11" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path className="fill" d="M0.899902 5.05844H9.8249L5.4449 0.648438H6.9449L11.8499 5.59844L6.9299 10.5484H5.4299L9.82621 6.13844H0.899902V5.05844Z" fill="black"/>
            </svg>
          </div>
        </button>
      </form>
