...
const DEFAULTS: Required<EventBannerProps> = {
  ...
  title: 'The Execution',
  titleAccent: 'Room.',
  tagline: 'Being busy isn\u2019t the same as making progress.',
  pillars: [
    { verb: 'Sharpen', noun: 'Priorities' },
    { verb: 'Build', noun: 'Discipline' },
    { verb: 'Deliver', noun: 'Results' },
  ],
  date: 'Thursday, 11th June 2026',
  location: 'Nairobi \u2014 Venue confirmed upon registration',
  investment: 'KES 15,000 \u00a0|\u00a0 Early bird KES 12,000 by 31st May',
  registrationUrl:
